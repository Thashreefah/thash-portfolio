...
5. Windows → **Credential Manager** → **Windows Credentials** →
`git:https://github.com` → **Remove**.
6. Run any push (e.g. double-click `upload.bat`) and log in as **Thashreefah**.
7. Done. Go to **STEP 1**.
...
8. **Double-click `start-auto-deploy.bat`** in this folder.
9. A black window opens that says *"Auto-deploy is watching..."*. **Leave it open.**
10. Edit your files (`index.html`, `style.css`, `script.js`) in any editor and **save**.
11. Within a few seconds the window says *"Pushed to GitHub. Netlify will go live in \~30s."*
12. Refresh your live site — your change is there. 🎉
